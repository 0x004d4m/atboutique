...
<head>
    ...
    <title>{{ __('forget_email.title') }}</title><!--[if (mso 16)]>
    <style type="text/css">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong><a target="_blank"
                                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#EF0D33;font-size:20px">{{ $Customer->forget_code }}</a></strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'Open Sans', sans-serif;line-height:30px;color:#262626;font-size:20px">
                                                                        <strong>{{ __('forget_email.text4') }}</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
