...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    <!-- include select2 css-->
    <link href="{{ asset('vendor/select2-2/dist/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('vendor/select2-bootstrap-theme/dist/select2-bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- include select2 js-->
    <script src="{{ asset('vendor/select2-2/dist/js/select2.full.min.js') }}"></script>
    @if (app()->getLocale() !== 'en')
    <script src="{{ asset('vendor/select2-2/dist/js/i18n/' . str_replace('_', '-', app()->getLocale()) . '.js') }}"></script>
    @endif
    @endpush
