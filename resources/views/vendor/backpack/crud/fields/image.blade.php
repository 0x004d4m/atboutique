...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        <link href="{{ asset('vendor/cropperjs/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
        <style>
            .image .btn-group {
                margin-top: 10px;
            }
    ...
    @push('crud_fields_scripts')
        ...
        <script src="{{ asset('vendor/jquery-cropper/dist/jquery-cropper.min.js') }}"></script>
        <script>
